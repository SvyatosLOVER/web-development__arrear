...
<html lang="ru">
  ...
  <body class="sheets">
    ...
    <header class="sheets__head">
      ...
      <button class="sheets__navigation-button">Записаться на курс</button> 
    </header>
    ...
    <main class="sheets__main">
      <div class="main__inviting">
        <div class="inviting__text-block">
          ...
          <button class="inviting__button"><span class="inviting__button__text">Записаться на курс</span></button>
        </div> 
